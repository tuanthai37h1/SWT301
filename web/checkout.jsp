            ...
            <div class="container" style="min-height: 1000px">
                ...
                <div class="row">
                    <div class="col-md-8" style="border: 1px solid #ccc; border-radius: 5px; padding: 1rem">
                        ...
                        <p><a href="carts" class="btn btn-danger" >Back</a></p>
                        <p><a href="home" class="btn btn-primary" >Buy Something...</a></p>
                    </div>
                    <div class="col-md-4" style="border: 1px solid #ccc; border-radius: 5px; padding: 1rem">
                        ...
                        <form action="checkout" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" aria-describedby="emailHelp" value="+(84)">
                            </div>
                            <div class="mb-3">
